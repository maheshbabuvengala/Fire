    ...
    <div>
      ...
      <div class="container">
        ...
        <p>
          ...
          constitute a binding agreement by and between FIRESCRIM, Website Owner
          and you and relate to your use of our website,services
        </p>
        <p>
        ...
        <ul>
          ...
          <li>If you lose the game no refund of money.</li>
          <li>
            You should not play the game without registering. If you do , you
            will not get money.
          </li>
          <li>
            After registering,once you enter the room you should not allow
            others to join.
          </li>
          <li>We are not responsible if you repeatedly lose the game.</li>
          <li>
            If you are registered and have not played game there will be
            no refund of money.
          </li>
          <li>
